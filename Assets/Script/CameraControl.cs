...
public class CameraControl : MonoBehaviour
{
    ...
    void Start()
    {
        origine = new Vector3(0f, 0f, 0f); //相機目標設為 世界座標中心
    }
    ...
    public IEnumerator TopToSide_IE(Transform objTransform)
    {
        ...
        Vector3 stepVector3 = new Vector3(sideViewV3.x - iniPos.x, sideViewV3.y -iniPos.y, sideViewV3.z - iniPos.z) / 40f; //每次移動距離
